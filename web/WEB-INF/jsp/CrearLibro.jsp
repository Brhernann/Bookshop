            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Formulario Libro
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                      ...
                      <div class="col-lg-6">
                         ...
                         <input name="txtnombreautor" type="text" class="form-control" required autocomplete placeholder="Nombre Autor">
                         <input name="txtstock" type="text" class="form-control" required autocomplete placeholder="Stock">
                         <br>
                         <div class="col-lg-4">
