            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            LIBRERIA <small>Panel de control</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Bienvenido</strong> nuevamente <a href="" class="alert-link">Brhernann</a> !
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-book fa-fw"></i> Ultimos prestamos</h3>
                            </div>
                            <div class="panel-body">
